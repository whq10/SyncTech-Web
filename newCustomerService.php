...
else
{
	...
	$query = "insert into customer (id, name, postcode, birthday, points, tel, redeem, email, status) VALUES('".$customer_id."', '".$name."', '".$postcode."', '".$birthday."', '".$points."', '".$telephone."', 'null', '".$email."', 'Active')";
