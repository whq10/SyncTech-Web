...
?>
    ...
    <!-- <style> -->
<form action="email_send_result.php" method="post">
	<div class="content">
                                                        ...
                                                        <table>
                                                            <tr>
                                                                <th>
                                                                    <h2>Email body:</h2>
                                                                    <p>
																	<textbox name="receiver" value="ytt10@sina.com"/>
                                                                        <textarea name="body">Edit group email here.</textarea>
                                                                    </p>                                                                
                                                                </th>
                                                            </tr>
                                                            <tr>
                                                                            ...
                                                                            <td>
                                                                                <table>
                                                                                    <tr>
                                                                                        <td>
                                                                                            <center data-parsed="">
                                                                                                <input type="submit" value="Send Me" class="btn btn-default" />
                                                                                            </center>
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
                                                                    ...
                                                                    <table class="callout">
                                                                        <tr>
                                                                            <th class="callout-inner secondary">
                                                                                ...
                                                                                <table class="button twitter expand">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td>
                                                                                            <table>
                                                                                                <tr>
                                                                                                    <td><label><input type="checkbox" id="cbox3" value="third_checkbox" />Sending Frequency:</label></td>
                                                                                ...
                                                                                <p>CONTACT INFO:</p>
                                                                                <p>Phone: 204-890-8387</p>
                                                                                <p>Email: <a href="mailto:whq10@sina.com">whq10@sina.com</a></p>
                                                                            </th>
